...
### Publications
***
* **AutoMSR: Auto Molecular Structure Representation Learning for Multi-label Metabolic Pathway Prediction.** <br> **Jiamin Chen**, Jianliang Gao, Tengfei Lyu, Babatounde MOCTARD Oloulade, Xiaohua Hu (<font face="微软雅黑" color=blue size=3>TCBB</font> 2022 CCF B). [Accepted]
* **Memory Augmented Graph Learning Networks for Multivariate time series Forecasting** <br> Xiangyue Liu, Xinqi Lyu, Xiangchi Zhang, Jianliang Gao, **Jiamin Chen** (<font face="微软雅黑" color=blue size=3>CIKM</font> 2022 CCF B). [Accepted]
...
* **Graph neural architecture search: A survey.** <br> Babatounde Moctard Oloulade, Jianliang Gao, **Jiamin Chen**, Tengfei Lyu, Raeed Al-Sabri (<font face="微软雅黑" color=blue size=3>TST</font> 2021 JCR Q1). [Paper](https://ieeexplore.ieee.org/document/9645440/authors#authors)
